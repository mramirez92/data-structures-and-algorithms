...
Write a function that iterates over an array of people objects arr
and creates a new list of each person's full name using the array method 'map'.
Each object will have the shape {firstName:string, lastName:string} spread ...
...
const addValues = (arr) => arr.reduce((acc,val)=>{ return acc+=val;},0);
//  {
...
const addPurchases = (arr) =>arr.reduce((total, element)=>{return total+=element.purchasePrice;},0);
// Solution code here...
...
const countNumberOfElements = (arr) => arr.reduce((total)=>{return total+1;},0);
// Solution code here...
...
Note: You must use reduce for this challenge. You may not use the built-in .reverse() string method. index at -1
------------------------------------------------------------------------------------------------ */
// 'hello'
//
// ['h', 'e' ,'l', 'l', 'o']
...
// e + 'h' =  'e' + 'h'
//
// favcolorlower = col.tolowerCase()
// col.tolowercase().split('').toUpperCase();
